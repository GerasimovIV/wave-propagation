...
class ConvGRUCell(nn.Module):
    def __init__(self,# input_size, 
                 input_dim, hidden_dim, kernel_size, bias, dtype):
        """
...
class ConvGRU(nn.Module):
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        if hidden_state is not None:
            ...
            #assert input_tensor.size(0) == hidden_state.size(0)
        else:
            hidden_state = self._init_hidden(input_tensor.shape[0], input_tensor.shape[3], input_tensor.shape[4])
...
if __name__ == '__main__':
    ...
    #print(last_state_list[0][0] == layer_output_list[0][0][-2])